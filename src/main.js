...
const user_post = document.querySelector(".user-post-list")
...
const showLatestPosts = () =>{
   ...
   if(posts.length > 0){
         posts.reverse().map((item, index) =>{
            ...
            <div style="margin-bottom:20px;" class="user-post">
...
create_post_form.onsubmit = (e) =>{
    ...
    if(!data.author_name || !data.author_photo){
       msg.innerHTML = createAlert('Author Name & Photo as required')
    }else{
     // get prev data
